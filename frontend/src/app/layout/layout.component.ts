    ...
    <mat-sidenav-container class="app-container">
      ...
      <mat-sidenav-content class="content">
        ...
        <div class="toolbar">
          ...
          <div class="toolbar-right">
            ...
            <div class="toolbar-user">
              <span class="toolbar-username">{{ auth.currentUser?.name }}</span>
            ...
            <button mat-icon-button class="toolbar-icon-btn" matTooltip="Logout" (click)="auth.logout()">
        ...
        <div class="top-bar">
          ...
          @if (permissions.hasPermission('stats:read')) {
            <button
              mat-stroked-button
              class="rounded-full buttontam"
              routerLink="/stats"
